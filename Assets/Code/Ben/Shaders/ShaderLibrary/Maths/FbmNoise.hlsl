...
// Adapted from: MarcoF (https://www.shadertoy.com/view/ss2cDK)
...
float FbmNoise(float3 position, float scale, float detail, float roughness, float lacunarity)
{
    float amplitude = 0.5;
    float frequency = 1.0;
    ...
    {
        total += amplitude * _Noise(p * frequency);
